...
def build_reversed_bags_hash(bags_hash: Dict[str, Bag]):
    reversed_bags_hash = {}
...
def get_all_containing_bags(reversed_bags_hash: Dict[str, List[str]], to_find: str):
    current_set = {to_find}
    while True:
...
def generate_bag_values(bags_hash: Dict[str, Bag], reversed_bags_hash: Dict[str, List[str]]):
